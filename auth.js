...
import {getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword,singOut, sendPasswordResetEmail,onAuthStateChanged}
from "https://www.gstatic.com/firebasejs/11.6.0/firebase-auth.js";

//CADASTRAR USUARIO 

const emailCasdastroInput = document.getElementById("emailCadastro");
const senhaCasdastroInput = document.getElementById("senhaCadastro");
...
throw { message: mensagemErro};
    ...
    if (btnCadastro){
        btnCadastro.addEventListener('click',async function () {
            const email = emailCasdastroInput.value;
            const senha = senhaCasdastroInput.value;
